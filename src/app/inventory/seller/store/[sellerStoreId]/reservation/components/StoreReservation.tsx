                                        ...
                                        <Grid container rowSpacing={1}>
                                            <Grid container item xs={8}>
                                                <Grid container item xs={12} justifyContent={"center"} alignItems={"center"}>
                                                    <Chip
                                                        label={
                                                            row.reservations.reservation_status.code === 1
                                                                ? row.reservations.reservation_status.name + " (" + row.units_quantity + ")"
                                                                : row.units_quantity + " | " + row.reservations.reservation_status.name
                                                        }
                                                        size={"small"}
                                                        //@ts-ignore
                                                        color={reservationStatusColors[row.reservations.reservation_status.code]}
                                                    />
                                            ...
                                            <Grid item container xs={4} justifyContent={"center"}>
                                                ...
                                                {
                                                    row.reservations.reservation_status.code === 3 && (
                                                        <>
                                                            {
                                                                row.reservations.request_delivery ? (
                                                                    <IconButton
                                                                        color={"warning"}
                                                ...
                                                {
                                                    row.reservations.reservation_status.code === 5 && (
                                                        <>
                                        ...
                                        <Collapse in={expandIndex === row.id} timeout="auto" unmountOnExit>
                                            <Grid container spacing={1} sx={{ padding: "8px 26px" }}>
                                                ...
                                                <Grid container item spacing={1} xs={12}>
                                                    ...
                                                    <Grid item xs={true}>
                                                        <Chip
                                                            label={`${row.reservations.reservation_status.name} | ${row.units_quantity} Productos`}
                                                            size={"small"}
                                                            //@ts-ignore
                                                            color={reservationStatusColors[row.reservations.reservation_status.code]}
                                                            sx={{ mr: "5px" }}
                                                ...
                                                <Grid container item spacing={1} xs={12}>
                                                    ...
                                                    <Grid item xs={true}>
                                                        {`${row.reservations.users.name} (${row.reservations.users.username})`}
                                                    </Grid>
                                                </Grid>

                                                {
                                                    row.reservations.request_delivery && (
                                                        <Grid container item spacing={1} xs={12} alignItems={"center"}>
                                                            ...
                                                            {
                                                                row.reservations.delivery_notes && (
